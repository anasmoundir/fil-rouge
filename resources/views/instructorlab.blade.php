                    ...
                    <div class="mb-4">
                        ...
                        <div id="lesson-resources-container">
                            <div class="file-input">
                                <input type="file" name="lesson_resources[]"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('lesson_resources') border-red-500 @enderror">
