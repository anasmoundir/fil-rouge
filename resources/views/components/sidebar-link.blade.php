<ul class="w-full">
      ...
      <li class="relative">
        <a href="#" class="sidebar-item block py-2 px-4" onmouseover="showSubcategories()" onmouseout="hideSubcategories()">
          <div  class="flex item-center">
            <x-heroicon-o-book-open class="w-5 h-5 mr-2"/>
            <span class="sidebar-item-text">Courses</span>
          </div>
        </a>
        <ul id="subcategories" class="sidebar-sublist absolute top-full left-full mt-2 ml-2 bg-white shadow rounded-lg hidden">
          <li><a href="#" class="block py-1 px-2 hover:bg-gray-100">Mathematics</a></li>
