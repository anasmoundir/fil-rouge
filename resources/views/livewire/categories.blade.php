            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form wire:submit.prevent="createCategory" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.defer="name" id="name" class="form-input w-full" required>
                    </div>

                    <div class="mb-4">
                        <label for="image" class="block mb-2 font-bold text-gray-700">Upload Image</label>
                        <input type="file" wire:model.defer="image" id="image" class="form-input w-full" required>
                    </div>
                    ...
                    <div class="flex justify-end">
                        ...
                        <button type="submit" wire:click="createCategory" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Create
                        </button>
                    </div>
                </form>
