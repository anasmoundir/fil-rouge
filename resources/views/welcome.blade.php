...
<body class="antialiased">
    ...
    <main>
        ...
        <section class="text-center py-16">
            <h1 class="text-4xl font-bold mb-4">Wait for it...</h1>
            <p class="text-gray-600">Our waiters are getting ready to serve you the best online learning experience.</p>
        </section>
        <footer class="bg-gray-900 text-gray-400 px-4 py-8 flex flex-col items-center justify-center">
            <div class="flex mb-4">
                <a href="#" class="mx-4 hover:text-gray-300">About Us</a>
                <a href="#" class="mx-4 hover:text-gray-300">Contact Us</a>
                <a href="#" class="mx-4 hover:text-gray-300">Privacy Policy</a>
            </div>
            <div class="text-sm text-gray-400">
                © 2023 BrainRose LMS. All rights reserved.
            </div>
            <div class="text-sm text-gray-400 mt-4">
                El Youssoufia, Morocco | +212 661 66 66 00
            </div>
        </footer>
        <script>
